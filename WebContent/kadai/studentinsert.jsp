...
            <input type="text" name="no" id="no" maxlength="10" required placeholder="学生番号を入力してください"><br>

            <label for="name">氏名</label><br>
            <input type="text" name="name" id="name" maxlength="30" required placeholder="氏名を入力してください"><br>
